...
-- Avaliacoes
INSERT INTO Avaliacoes (id_usuario, id_produto, nota, comentario, data_avaliacao) VALUES
(1, 1, 4.5, 'Ótimo notebook, desempenho excelente!', '2025-03-26'),
(2, 2, 4.0, 'Smartphone rápido e câmera boa.', '2025-03-21'),
(3, 3, 5.0, 'Teclado incrível, muito confortável.', '2025-03-16'),
(4, 4, 4.2, 'Mouse confortável, mas poderia ter mais botões.', '2025-03-23'),
(5, 5, 4.8, 'Monitor de alta qualidade, adorei!', '2025-03-28'),
(6, 6, 4.6, 'Cadeira muito confortável!', '2025-03-19'),
(7, 7, 4.1, 'Boa impressora, mas um pouco lenta.', '2025-03-18'),
(8, 8, 5.0, 'Som excelente, cancelamento de ruído perfeito!', '2025-03-17'),
(9, 9, 4.0, 'Relógio inteligente muito funcional.', '2025-03-27'),
(10, 10, 4.3, 'Bom HD externo, armazenamento ótimo.', '2025-03-23');
